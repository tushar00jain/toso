...
It implements :class:`proposed.policy.Placement`'s one member by storing the
...
class PlacementService:
    ...
    Args:
        control: the capability's control plane -- a
            :class:`proposed.policy.Placement`. This service holds it and forwards;
            it decides nothing.
    """
